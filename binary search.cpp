...
// Binary Search function supporting long long
...
int main() {
    ...
    if (choice == 'y' || choice == 'Y') {
        ...
        random_device rd;
        mt19937_64 gen(rd());
        uniform_int_distribution<long long> dist(1e12, 9e12); // Generate large long long numbers
    ...
    cout << "\nBinary search runtime: " << elapsed_us << " microseconds" << endl;
